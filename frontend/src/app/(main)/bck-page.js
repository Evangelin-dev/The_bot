        ...
        >
          <div className="col-md-6">
            <div className="container text-center">
              ...
              <div className="text-danger fs-1 fw-bolder">
                Under Construction
              </div>
              <div className="fs-2 fw-bold">We&apos;ll Be Back Soon.</div>
              <div className="text-success-emphasis fs-5">
                We&apos;re busy upgrading with new technology. We apologize for the
                inconvenience.
              </div>
              <div className="text-body-emphasis fs-5">
          ...
          <div className="text-center">
            <div className="logo-cover">
              <Image src="/logo.png" alt="Picture of the author" fill />
            </div>
            <div>© Copyright 2024, All Rights Reserved by TheBot.</div>
          </div>
        </div>
      </div>
    </>
