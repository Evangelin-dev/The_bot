...
export const SERVICES = [
  { name: "Marketing Strategies", url: "marketing-strategies" },
  { name: "Predictive Market Analysis", url: "predictive-analysis" },
  { name: "Lead Generation", url: "lead-generation" },
  { name: "Branding", url: "branding" },
  { name: "Web Development", url: "web-development" },
  { name: "Social Media Management", url: "social-media-management" },
  { name: "Tech Development", url: "tech-development" },
  { name: "App Development", url: "app-development" },
  { name: "Seo", url: "seo" },
  { name: "Website in 3 days", url: "web-development/3-days-delivery" },
];

export const INDUSTRIES = [
  { name: "B2B Businesses", url: "b2b-business" },
  { name: "B2C Businesses", url: "b2c-business" },
  { name: "Logistics Businesses", url: "logistics-businesses" },
  { name: "Saas Company", url: "saas-company" },
  { name: "Start Up", url: "start-up" },
  { name: "B2B Exporter", url: "b2b-exporter" },
];
            ...
            <li className="nav-item dropdown dropdown-nav px-1">
              ...
              <ul className="dropdown-menu" aria-labelledby="industriesDropDown">
                {INDUSTRIES.map((industry, idx) => (
                  <li key={idx}>
                    <Link href={`/industries/${industry.url}`}>
                      <span
                        className="dropdown-item"
                        data-bs-toggle="collapse"
                        data-bs-target=".navbar-collapse.show"
